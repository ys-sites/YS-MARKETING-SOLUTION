...
const projects = [
  ...
  { id: 7, slug: "tierexotics",  name: "A-Tier Exotics",           category: "Luxury Services",     url: "https://atierexotic.com", altEn: "A-Tier Exotics luxury car rental website design — Montreal", altFr: "Conception de site web de location de voitures de luxe pour A-Tier Exotics — Montréal" },
